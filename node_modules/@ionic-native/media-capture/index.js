...
var MediaCapture = (function (_super) {
    ...
    /**
       ...
       * @returns {Promise<MediaFile[]>}
       */
    MediaCapture.prototype.captureAudio = /**
       * Start the audio recorder application and return information about captured audio clip files.
       * @param options
       * @returns {Promise<MediaFile[]>}
       */
    ...
    /**
       ...
       * @returns {Promise<MediaFile[]>}
       */
    MediaCapture.prototype.captureImage = /**
       * Start the camera application and return information about captured image files.
       * @param options
       * @returns {Promise<MediaFile[]>}
       */
    ...
    /**
       ...
       * @returns {Promise<MediaFile[]>}
       */
    MediaCapture.prototype.captureVideo = /**
       * Start the video recorder application and return information about captured video clip files.
       * @param options
       * @returns {Promise<MediaFile[]>}
       */
    ...
    /**
       ...
       * @returns {Observable<MediaFile[]>}
       */
    MediaCapture.prototype.onPendingCaptureResult = /**
       * is fired if the capture call is successful
       * @returns {Observable<MediaFile[]>}
       */
    function () {
    ...
    /**
       ...
       * @returns {Observable<CaptureError>}
       */
    MediaCapture.prototype.onPendingCaptureError = /**
       * is fired if the capture call is unsuccessful
       * @returns {Observable<CaptureError>}
       */
    function () {
